...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/SandakanVPNTrickster/permission/main/bot  > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/SandakanVPNTrickster/permission/main/bot  | grep $MYIP | awk '{print $2}')
Isadmin=$(curl -sS https://raw.githubusercontent.com/SandakanVPNTrickster/permission/main/bot  | grep $MYIP | awk '{print $5}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/SandakanVPNTrickster/permission/main/bot  | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
    res="Izin Ditolak!"
...
Exp=$(curl -sS https://raw.githubusercontent.com/SandakanVPNTrickster/permission/main/bot  | grep $MYIP | awk '{print $3}')
fi
